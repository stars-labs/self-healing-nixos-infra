...
import HealingWorkflow from '../../../components/HealingWorkflow.jsx';
import TerminalReplay from '../../../components/TerminalReplay.jsx';
import TierSimulator from '../../../components/TierSimulator.jsx';
...
<HealingWorkflow lang="zh" client:only="react" />

## 终端操作

模拟终端会话，展示快照管理、回滚操作和 OpenClaw AI 运维的真实命令。选择一个标签页并点击**播放**观看。

<TerminalReplay lang="zh" client:only="react" />
...
<TierSimulator lang="zh" client:only="react" />
